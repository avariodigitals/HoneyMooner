...
class HM_Package_Meta {
    ...
    public static function render(WP_Post $post): void {
        ...
        $meta_keys = ['package_id','destination_id','category','subtitle','summary','intro_content','experience_content','days','nights','starting_price','currency','pricing_basis','rating','review_count','seo_title','meta_description','canonical_url'];
        $meta = [];
        ...
        <div class="hm-section">
            ...
            <p><label><strong>Experience Content</strong></label><textarea class="widefat" rows="6" name="hm_package[experience_content]"><?php echo esc_textarea($meta['experience_content']); ?></textarea></p>
        </div>
        ...
        <div class="hm-section">
            ...
            <div class="hm-grid hm-grid-4">
                ...
                <p><label><strong>Currency</strong></label><input class="widefat" type="text" name="hm_package[currency]" value="<?php echo esc_attr($meta['currency'] ?: 'USD'); ?>"></p>
    ...
    public static function save(int $post_id): void {
        ...
        foreach (['package_id','category','subtitle','summary','intro_content','experience_content','currency','pricing_basis','seo_title','meta_description'] as $field) {
